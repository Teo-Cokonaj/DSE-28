...
#Load parameters
mtow=35.25                      # Maximum Takeoff Weight of the drone [kg]
max_g_load=6                  # Maximum g-load based on Aerobatic CS-23 classification
...
#Fuselage parameters
fuselage_length=3.42                               # Total length of the fuselage [m]
fuselage_diameter=0.315                          # Fuselage diameter [m]
minimum_thickness=0.0003                           # Minimum manufacturing thickness [m] - 1mm default
...
cg_loc=1.44             # Distance from nose to CG [m]
canard_loc=0.3                  # Distance from tip of the fuselage to canard port [m]
main_wing_loc=2.1               # Distance from nose to main wing [m]
empennage_loc=3.1              # Distance from nose to empennage [m]
...
#Analysis parameters
resolution = int(fuselage_length * 1000 + 1)                                  # Higher resolution for integration accuracy
