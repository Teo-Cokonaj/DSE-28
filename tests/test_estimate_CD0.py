...
class TestCD0Estimate:
    def test_compare_with_year2_aircraft(self):
        ...
        assert np.isclose(fuselage.Cf(altitude, mach_cruise), 0.001755855), fuselage.Cf(altitude, mach_cruise)
        assert np.isclose(fuselage.CD0_contribution(altitude, mach_cruise), 0.001755855*1.072477)
