...
if z_location_mainwing > fuselage_radius:
    raise ValueError("Warning: Main wing extends above the top of the fuselage. Decrease z_location_mainwing.")
...
#Canard parameters
canard_lift_fraction=0                      # Fraction of total lift generated by the canard in relation to main wing.
...
z_location_canard = -0.5                       # Z-location of top part of the canard [m]

if z_location_canard > fuselage_radius:
    raise ValueError("Warning: Canard extends above the top of the fuselage. Decrease z_location_canard.")
